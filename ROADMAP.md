...
| 8 | Búsqueda, revisión por lotes, glosario global y productividad | En curso — 8.1 incluida en la beta 7 pública; 8.2 implementada en `main` y pendiente de publicación/validación física; revisión por lotes y glosario global siguen planificados |
