...
- Versión publicada actual: [`0.2.0-beta.11`](https://github.com/Andres-MMG/Trazio-Asistente-Reunion/releases/tag/v0.2.0-beta.11), secuencia de instalador **12**
- Versión anterior: `0.2.0-beta.10`, secuencia de instalador **11**; se conserva como evidencia histórica
...
| 8 | Búsqueda, revisión por lotes, glosario global y productividad | En curso — 8.1, 8.2, 8.3a, 8.3b y la revisión individual 8.4a publicadas en beta 11; selección múltiple, aprobación masiva, aplicación del diccionario y validación física siguen pendientes |
