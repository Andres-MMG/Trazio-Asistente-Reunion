...
| 8 | Búsqueda, revisión por lotes, glosario global y productividad | En curso — 8.1, 8.2, 8.3a y 8.3b incluidas en beta 10; 8.4a individual implementada solo en `main`; selección múltiple, aprobación masiva, aplicación del diccionario y validación física siguen pendientes |
