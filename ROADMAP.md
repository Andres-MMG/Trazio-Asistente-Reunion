...
| 8 | Búsqueda, revisión por lotes, glosario global y productividad | En curso — 8.1 y 8.2 incluidas en beta 8; 8.3a implementada en `main` pero no publicada; validación física, revisión por lotes y gestión avanzada siguen pendientes |
...
- **8.3a implementada en `main`, todavía no publicada:** tercera pestaña **Diccionario** con lista global más reciente primero, ordinal público, filtro en memoria por términos/categoría y selector Todos/Activos/Inactivos. Permite activar o desactivar cada entrada por su ID interno sin mostrarlo; los duplicados históricos siguen separados. La carga falla cerrada ante corrupción y conserva un máximo de 120 filas visibles.
