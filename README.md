...
| Etapa 8.3b — intercambio del diccionario | Implementada en `main`, aún no publicada: JSON v1, vista previa, importación cifrada atómica, exportación explícita sin cifrar y avisos visuales de duplicados/conflictos sin fusión destructiva |
