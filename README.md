...
[Descargar v0.2.0-beta.11](https://github.com/Andres-MMG/Trazio-Asistente-Reunion/releases/tag/v0.2.0-beta.11) · [Primeros pasos](docs/user-guide.md) · [Arquitectura](docs/architecture.md) · [Hoja de ruta](ROADMAP.md) · [Documentación](docs/README.md)

> **Beta funcional publicada — todavía no validada para producción.** `v0.2.0-beta.11` es la descarga pública actual. Incorpora la bandeja individual 8.4a, además de las funciones publicadas hasta 8.3b. No incorpora revisión masiva, aplicación automática del diccionario, entrenamiento, calendario ni identificación de hablantes. La validación física audible, WGC/GPU, interfaz, accesibilidad, Meet/Teams reales y las pruebas de 2/5 horas siguen pendientes. El ZIP y el Setup no están firmados.

> **Evidencia inmutable de `v0.2.0-beta.11`.** El tag resuelve al commit `a0009902fa9e3d6eccad46844df90336077a5555`. El ZIP oficial mide **86,928,062 bytes** y su SHA-256 es `81ded5f88ca7875efce8e0c73df852e7cefc0d9f51cdfbb614ba60ce2c39b934`. El Setup oficial mide **60,073,131 bytes**, su SHA-256 es `b651727474ad50ea0f817bab8f363533d87c34cb5452510ed175e46857111bc0` y Authenticode informa `NotSigned`. Los seis recursos remotos coinciden en tamaño y digest. La release es una prerelease pública, no un borrador.
...
> **Bandeja individual 8.4a publicada en beta 11.** Reúne hasta 100 segmentos pendientes de sesiones completadas o interrumpidas, abre uno por vez sin reproducir audio, permite guardar una corrección o confirmar el original y reabrir únicamente una aprobación original. No incorpora selección múltiple, aprobación masiva, aplicación automática del diccionario, entrenamiento ni inteligencia externa.
...
| Etapa 8.4a — bandeja de revisión individual | Publicada en beta 11: pendientes globales acotados, selección única, aprobación del original y reapertura anexada; sin reproducción automática, revisión masiva ni aplicación del diccionario |
