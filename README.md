...
| Disponible en la versión pública beta 7 | Qué significa |
|---|---|
...
| Búsqueda local segura 8.2 en `main` | Busca manualmente títulos y el texto efectivo de la transcripción original, ignorando mayúsculas y diacríticos. Descifra y compara en memoria sin FTS ni índice de texto plano; una corrección activa reemplaza el original y deshacerla lo restaura. Está preparada para la próxima beta, no forma parte del paquete beta 7. |
...
| Etapa 8.2 — búsqueda local | Implementada en `main`: consulta explícita, cancelable y generacional sobre títulos y texto efectivo original/corregido; máximo 100 resultados visibles, sin FTS/índice persistente y sin reproducción automática. Espera publicación y validación física de interfaz/accesibilidad |
