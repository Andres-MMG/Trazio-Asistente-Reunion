...
> **Código posterior a beta 8, todavía no publicado.** La rama `main` incorpora la etapa 8.3a: una pestaña **Diccionario** para listar, filtrar y activar/desactivar entradas globales cifradas. No aplica términos a Whisper, no reemplaza transcripciones y no agrega una capacidad empaquetada. La descarga beta 8 todavía no contiene esta pestaña.
...
| Diccionario global 8.3a en `main` | El código posterior a beta 8 lista todas las entradas descifradas, filtra en memoria por términos/categoría y permite marcar cada duplicado histórico como activo o inactivo de forma independiente. Todavía no se publicó ni modifica Whisper. |
...
| Etapa 8.3a — diccionario global | Implementada en `main`, todavía no publicada: tercera pestaña, filtro local por términos/categoría y estado, máximo 120 filas visibles y activación por entrada. La aplicación del diccionario, duplicados/importación/exportación y la validación física siguen pendientes |
