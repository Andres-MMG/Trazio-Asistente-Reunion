...
> **8.4a implementada en la fuente de `main`, todavía no publicada.** La descarga pública actual continúa siendo `v0.2.0-beta.10`. La nueva bandeja **Pendientes de revisión** reúne hasta 100 segmentos de sesiones completadas o interrumpidas, permite abrir uno por vez sin reproducir audio, guardar una corrección o confirmar el original, y reabrir únicamente una aprobación original. No incorpora selección múltiple, aprobación masiva, aplicación automática del diccionario, entrenamiento ni inteligencia externa.
...
| Etapa 8.4a — bandeja de revisión individual | Implementada en `main`, todavía no publicada: pendientes globales acotados, selección única, aprobación del original y reapertura anexada; sin reproducción automática, revisión masiva ni aplicación del diccionario |
