...
| Etapa 9.1 — configuración de inteligencia externa | Publicada en beta 15/secuencia 16: URL/modelo/clave protegidos con DPAPI, clave no redisplayada, HTTPS remoto y HTTP solo loopback. No existe todavía una llamada de red ni salida de transcripción; resumen, traducción, clasificación y consentimiento por operación siguen pendientes |
