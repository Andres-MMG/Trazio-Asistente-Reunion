...
try {
    $payloadA = New-SyntheticPayload -Label "A" -Version "0.2.0-beta.7" -Sequence 8
    $payloadB = New-SyntheticPayload -Label "B" -Version "0.2.0-beta.8" -Sequence 9
    $payloadC = New-SyntheticPayload -Label "C-failure" -Version "0.2.0-beta.9-harness" -Sequence 10 -IncludeRollbackTrigger
    ...
    $productOverrideCases = [ordered]@{
        ...
        OutputBaseFilename = "Trazio-Asistente-Reunion-v0.2.0-beta.8-Setup"
        TestWorkspaceRoot = $workspace
