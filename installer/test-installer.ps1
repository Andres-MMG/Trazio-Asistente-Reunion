...
try {
    $payloadA = New-SyntheticPayload -Label "A" -Version "0.2.0-beta.8" -Sequence 9
    $payloadB = New-SyntheticPayload -Label "B" -Version "0.2.0-beta.9" -Sequence 10
    $payloadC = New-SyntheticPayload -Label "C-failure" -Version "0.2.0-beta.10-harness" -Sequence 11 -IncludeRollbackTrigger
    ...
    $productOverrideCases = [ordered]@{
        ...
        OutputBaseFilename = "Trazio-Asistente-Reunion-v0.2.0-beta.9-Setup"
        TestWorkspaceRoot = $workspace
