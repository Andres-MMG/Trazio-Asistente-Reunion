...
try {
    $payloadA = New-SyntheticPayload -Label "A" -Version "0.2.0-beta.10" -Sequence 11
    $payloadB = New-SyntheticPayload -Label "B" -Version "0.2.0-beta.11" -Sequence 12
    $payloadC = New-SyntheticPayload -Label "C-failure" -Version "0.2.0-beta.12-harness" -Sequence 13 -IncludeRollbackTrigger
    ...
    $productOverrideCases = [ordered]@{
        ...
        OutputBaseFilename = "Trazio-Asistente-Reunion-v0.2.0-beta.11-Setup"
        TestWorkspaceRoot = $workspace
