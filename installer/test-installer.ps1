...
try {
    $payloadA = New-SyntheticPayload -Label "A" -Version "0.2.0-beta.9" -Sequence 10
    $payloadB = New-SyntheticPayload -Label "B" -Version "0.2.0-beta.10" -Sequence 11
    $payloadC = New-SyntheticPayload -Label "C-failure" -Version "0.2.0-beta.11-harness" -Sequence 12 -IncludeRollbackTrigger
    ...
    $productOverrideCases = [ordered]@{
        ...
        OutputBaseFilename = "Trazio-Asistente-Reunion-v0.2.0-beta.10-Setup"
        TestWorkspaceRoot = $workspace
