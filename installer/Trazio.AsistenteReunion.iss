...
#ifndef MyAppVersion
  #define MyAppVersion "0.2.0-beta.15"
#endif
#ifndef MyReleaseSequence
  #define MyReleaseSequence 16
#endif
#ifndef MyAppGuid
...
begin
  ...
  if VersionText = CurrentVersion then
    ...
    Sequence := 8
  else if VersionText = '0.2.0-beta.8' then
    Sequence := 9
  else if VersionText = '0.2.0-beta.9' then
    Sequence := 10
  else if VersionText = '0.2.0-beta.10' then
    Sequence := 11
  else if VersionText = '0.2.0-beta.11' then
    Sequence := 12
  else if VersionText = '0.2.0-beta.12' then
    Sequence := 13
  else if VersionText = '0.2.0-beta.13' then
    Sequence := 14
  else if VersionText = '0.2.0-beta.14' then
    Sequence := 15
  else if VersionText = '0.2.0-beta.15' then
    Sequence := 16
  else
    Result := False;
end;
