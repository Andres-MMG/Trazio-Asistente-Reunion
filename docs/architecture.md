...
La versión pública actual `0.2.0-beta.11` incorpora la bandeja individual 8.4a además de las funciones publicadas hasta 8.3b. Conserva exactamente cinco capacidades; los perfiles Meet/Teams permanecen `Unvalidated`, no existe identificación de hablantes y siguen pendientes las validaciones físicas y de 2/5 horas.
...
La etapa 8.4a publicada en beta 11 añade una bandeja local e individual de pendientes entre sesiones, sin ampliar el manifiesto de capacidades ni introducir red, Whisper, LLM, calendario, diarización o identificación de hablantes.
