...
La etapa 8.3b forma el candidato `0.2.0-beta.10`, secuencia **11**, en `main`, todavía sin release: intercambio JSON v1, vista previa en memoria, importación cifrada atómica y exportación explícita sin cifrar. Conserva duplicados históricos, señala conflictos y no fusiona ni elimina entradas automáticamente. La versión pública continúa siendo beta 9.
