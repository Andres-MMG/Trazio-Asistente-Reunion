...
La versión publicada actual es [v0.2.0-beta.15](https://github.com/Andres-MMG/Trazio-Asistente-Reunion/releases/tag/v0.2.0-beta.15), una prerelease pública, no un borrador. El tag resuelve al commit 9a5c4af367e805fe1a8d0cd0a86722e03b1c1812. El ZIP mide **86,959,816 bytes**, SHA-256 0010af9e97d162835d0b109823fec00035a2013d2cd0ab8ee21fb9d75d7e4e7c; el Setup mide **60,104,288 bytes**, SHA-256 6fc40804fa7a3add3a2e823cb5e4c818f8fd07a39853612606e559f2aa883c8d. Los seis recursos remotos coinciden en tamaño y digest. Ninguna de estas comprobaciones sustituye evidencia física.
...
La rebanada 9.1 está publicada en beta 15/secuencia 16. Las pruebas focalizadas de política, persistencia DPAPI, interfaz y metadatos aprobaron **22/22**; el conjunto Release completo aprobó **671/671** en serie y **671/671** con paralelismo predeterminado; el harness desechable aprobó **14/14** y la compilación tuvo **0 advertencias/0 errores**. El payload contiene **495 archivos** y cinco capacidades. La release pública contiene seis recursos verificados y el Setup permanece NotSigned. No hay cliente HTTP ni prueba de proveedor real en esta rebanada.
...
| Beta 15 publicada con 9.1 | Proveedor y metadatos **22/22**; conjunto Release serial/paralelo **671/671**; harness **14/14**; solución Release **0 advertencias/0 errores**; payload **495** archivos, cinco capacidades y seis recursos remotos verificados. No contiene cliente HTTP ni constituye evidencia de proveedor real, interfaz física, accesibilidad, audio o 2/5 horas |
...
### Base 9.1 de proveedor externo — publicada en beta 15
