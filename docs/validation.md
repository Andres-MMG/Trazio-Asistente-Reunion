...
- [ ] Cambiar velocidad mientras reproduce y mientras está en pausa, también varias veces seguidas y cerca de una frontera entre fragmentos. Confirmar una sola salida activa, continuidad desde la posición audible, pausa conservada y limpieza del resaltado al finalizar/detener.
