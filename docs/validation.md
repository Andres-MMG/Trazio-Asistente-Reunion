...
El código actual prepara el candidato local `v0.2.0-beta.7`, secuencia **8**, con la revisión de historial 8.1 completa. No existe tag ni release pública beta 7. Sus artefactos locales no sustituyen la validación audible, de interfaz, teclado/lector de pantalla, Meet/Teams reales ni las sesiones de 2/5 horas.
...
| Pruebas de fuente del candidato beta 7/secuencia 8 | Versión/instalador/instancia **10/10**; conjunto Release serial **520/520**; conjunto Release paralelo **520/520**; compilación Release **0 advertencias/0 errores**; `VE000 verified`. Son pruebas automatizadas y sintéticas; no son evidencia física |
| ZIP local del candidato beta 7 | `Trazio-Asistente-Reunion-v0.2.0-beta.7-win-x64.zip`: **86,851,545 bytes**, SHA-256 `ed229082f41f2b02a795a8be5a3606d6a345a92a30429b3d4e98f74e39a7b3f7`; coincide **495/495** con el manifiesto por ruta, longitud y SHA-256. No está publicado |
| Setup local del candidato beta 7 | `Trazio-Asistente-Reunion-v0.2.0-beta.7-Setup.exe`: **60,025,956 bytes**, SHA-256 `3fdacaaeef1edc538fcf6bb472067fa91d2efc0289dbecb0376bbb3f04e677bb`; Authenticode `NotSigned`; compilado pero no ejecutado con identidad productiva. No está publicado |
| Manifiesto del payload beta 7 | `publish-manifest.json`: **123,575 bytes**, SHA-256 `3720c32bc389ba6fd0496526db5e4adbb0233e0015e201728bde714872615a4f`; **495** archivos, exactamente cinco capacidades y 0 entradas prohibidas, rutas locales o CodeView local |
...
Evidencia local del candidato beta 7/secuencia 8: las pruebas enfocadas aprobaron **10/10**, Release serial y paralelo **520/520**, el build Release terminó con **0 advertencias / 0 errores** y `VE000 verified`. Windows PowerShell 5.1 aprobó `publish`, smoke IPC integrado/explícito y el harness desechable **14/14**. El ZIP coincide **495/495** con el payload y reporta `ProductVersion` `0.2.0-beta.7+da7562b78fb15f311ca3ce30d610e4bd3409c31f` en App, Worker y `VisualAnalysis`; hubo 0 entradas prohibidas, rutas locales o CodeView local. El Setup permanece `NotSigned` y no fue ejecutado. Esta evidencia pertenece a artefactos locales: no existe tag ni release pública beta 7.
