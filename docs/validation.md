...
La gestión global 8.3a está implementada en `main`, después de beta 8, y todavía no forma parte de una release pública. Sus pruebas enfocadas cubren orden/filtro/conteos, duplicados independientes, activación persistente sin recifrar blobs, Undo, cascada al eliminar, corrupción fail-closed, lifecycle cancelable, copy honesta y conservación de exactamente cinco capacidades. Falta validación visual, de teclado y lector de pantalla en la aplicación ejecutada.
