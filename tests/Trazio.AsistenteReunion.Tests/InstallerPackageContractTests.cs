...
public sealed class InstallerPackageContractTests
{
    ...
    public void InnoSetup_UsesPerUserVersionedFailSafeContract()
    {
        ...
        Assert.Contains("#define MyAppVersion \"0.2.0-beta.12\"", script, StringComparison.Ordinal);
        Assert.Contains("#define MyReleaseSequence 13", script, StringComparison.Ordinal);
