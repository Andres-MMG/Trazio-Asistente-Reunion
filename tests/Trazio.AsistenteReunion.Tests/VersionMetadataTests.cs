...
{
    private const string ExpectedVersion = "0.2.0-beta.9";
    private const int ExpectedInstallerReleaseSequence = 10;
    private const string ExpectedReleaseArchive = "Trazio-Asistente-Reunion-v0.2.0-beta.9-win-x64.zip";
