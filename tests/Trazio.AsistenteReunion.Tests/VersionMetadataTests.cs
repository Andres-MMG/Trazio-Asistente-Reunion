...
{
    private const string ExpectedVersion = "0.2.0-beta.14";
    private const int ExpectedInstallerReleaseSequence = 15;
    private const string ExpectedReleaseArchive = "Trazio-Asistente-Reunion-v0.2.0-beta.14-win-x64.zip";
