...
{
    private const string ExpectedVersion = "0.2.0-beta.10";
    private const int ExpectedInstallerReleaseSequence = 11;
    private const string ExpectedReleaseArchive = "Trazio-Asistente-Reunion-v0.2.0-beta.10-win-x64.zip";
