...
{
    private const string ExpectedVersion = "0.2.0-beta.13";
    private const int ExpectedInstallerReleaseSequence = 14;
    private const string ExpectedReleaseArchive = "Trazio-Asistente-Reunion-v0.2.0-beta.13-win-x64.zip";
