...
{
    private const string ExpectedVersion = "0.2.0-beta.15";
    private const int ExpectedInstallerReleaseSequence = 16;
    private const string ExpectedReleaseArchive = "Trazio-Asistente-Reunion-v0.2.0-beta.15-win-x64.zip";
