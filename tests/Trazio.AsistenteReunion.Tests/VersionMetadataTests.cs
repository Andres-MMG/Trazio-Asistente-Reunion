...
{
    private const string ExpectedVersion = "0.2.0-beta.6";
    private const int ExpectedInstallerReleaseSequence = 7;
    private const string ExpectedReleaseArchive = "Trazio-Asistente-Reunion-v0.2.0-beta.6-win-x64.zip";
